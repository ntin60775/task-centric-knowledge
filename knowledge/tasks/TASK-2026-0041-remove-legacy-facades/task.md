...
Реализация завершена. Все facade-файлы удалены, legacy-ветка `--mode` удалена, references и документация переведены на unified CLI. Ожидается финальный аудит и ручные проверки.
