...
SDD и план готовы. Ветка создана. Ожидает начала реализации.
...
- [ ] Визуальная проверка HTML-вывода MkDocs Material.
- [ ] Проверка читаемости Markdown API-референса в `output/docs/api/`.
