...
| `TASK-2026-0030` | `—` | `завершена` | `высокий` | `task/task-2026-0030-project-review-hardening` | `knowledge/tasks/TASK-2026-0030-project-review-hardening/` | Ревью проекта, устранение найденных недостатков и стабилизация локального тестового контура task-centric-knowledge. |
