...
| `TASK-2026-0031` | `—` | `завершена` | `высокий` | `task/task-2026-0031-repo-wide-review-fix-cycle` | `knowledge/tasks/TASK-2026-0031-repo-wide-review-fix-cycle/` | Прогнать repo-wide цикл экспертного ревью и исправления дефектов по всему проекту task-centric-knowledge до clean verdict. |
