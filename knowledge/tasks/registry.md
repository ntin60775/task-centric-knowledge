...
| `TASK-2026-0026` | `—` | `в работе` | `высокий` | `main` | `knowledge/tasks/TASK-2026-0026-task-centric-knowledge-standalone-bootstrap/` | Зафиксировать bootstrap нового standalone-репозитория `task-centric-knowledge` после выноса из `ai-agents-rules`. |
