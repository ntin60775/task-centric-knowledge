...
def print_text_report(payload: dict[str, object]) -> None:
    ...
    print(f"compatibility_epoch={payload['compatibility_epoch']}")
    print(f"upgrade_status={payload['upgrade_status']}")
    print(f"execution_rollout={payload['execution_rollout']}")
    print(f"legacy_pending_count={payload['legacy_pending_count']}")
    print(f"reference_manual_count={payload['reference_manual_count']}")
