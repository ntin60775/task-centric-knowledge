...
- `bash scripts/check-docs-localization.sh knowledge/tasks/TASK-2026-0033-repo-wide-review-rerun knowledge/tasks/registry.md` — будет прогнано после финальной синхронизации task-артефактов.
