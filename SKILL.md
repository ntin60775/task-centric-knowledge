...
Операторские примеры запуска, порядок команд и JSON-контракт вынесены в `references/cli-reference.md`,
чтобы основной `SKILL.md` оставался нормативным, а не справочным.
Обзорный документ проекта: `README.md`.
